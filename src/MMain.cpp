...
#ifdef HAVE_SDL2_NET
	m_font->MenuText( 400, 160, _LNG_MAIN_STORY_, 0, m_sel);
	m_font->MenuText( 400, 195, _LNG_MAIN_LAN_, 1, m_sel);
	m_font->MenuText( 400, 230, _LNG_MAIN_DEAD_, 2, m_sel);
	m_font->MenuText( 400, 265, _LNG_MAIN_MRCHOVNIK_, 3, m_sel);
	m_font->MenuText( 400, 300, _LNG_MAIN_SETTING_, 4, m_sel);
	m_font->MenuText( 400, 335, _LNG_MAIN_HELP_, 5, m_sel);
	m_font->MenuText( 400, 370, _LNG_MAIN_CREDITS_, 6, m_sel);
	m_font->MenuText( 400, 410, _LNG_MAIN_EXIT_, 7, m_sel);
#else
...
int MMain::OnKey(int nChar)
{
	...
	case SDLK_RETURN :
		...
		case 1 : return MENU_LAN; break;
		case 2 : return MENU_DEADMATCH; break;
		case 3 : return MENU_MRCHOVNIK; break;
		case 4 : return MENU_SETTING; break;
		case 5 : return MENU_HELP; break;
		case 6 : return MENU_CREDITS; break;
		case 7 : return MENU_END; break;
		}
#else
		switch (m_sel) {
		case 0 : return MENU_SINGLE; break;
